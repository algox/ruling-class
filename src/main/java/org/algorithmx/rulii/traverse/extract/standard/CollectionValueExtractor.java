...
public class CollectionValueExtractor extends TypedValueExtractorTemplate<Collection<?>> {

    public CollectionValueExtractor() {
        super(Collection.class,0);
    }

    @Override
    public void extract(Collection<?> container, TypedValueProcessor processor) {
