...
public class DictionaryKeyExtractor extends TypedValueExtractorTemplate<Dictionary<?, ?>> {

    public DictionaryKeyExtractor() {
        super(Dictionary.class,0);
    }
    ...
    public void extract(Dictionary<?, ?> container, TypedValueProcessor processor) {
        ...
        Enumeration<?> enums = container.keys();
