...
import org.algorithmx.rulii.core.function.DecFunction;
import org.algorithmx.rulii.core.function.ExecutableBuilder;
import org.algorithmx.rulii.core.function.NoArgFunction;
import org.algorithmx.rulii.core.function.NovFunction;
import org.algorithmx.rulii.core.function.OctFunction;
import org.algorithmx.rulii.core.function.QuadFunction;
import org.algorithmx.rulii.core.function.QuinFunction;
import org.algorithmx.rulii.core.function.SeptFunction;
import org.algorithmx.rulii.core.function.SexFunction;
import org.algorithmx.rulii.core.function.TriFunction;
import org.algorithmx.rulii.core.function.UnaryFunction;
...
public class ConditionBuilder extends ExecutableBuilder {
    ...
    public static Condition build(String script) {
        return with((@Match(using = MatchByTypeMatchingStrategy.class) RuleContext context)
                    -> processScriptCondition(script, context.getScriptProcessor(), context.getBindings()))
                .build();
    }
