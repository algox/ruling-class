...
import org.algorithmx.rulii.lib.spring.core.annotation.MergedAnnotations.SearchStrategy;
import org.algorithmx.rulii.lib.spring.lang.Nullable;

/**
 * {@code AnnotationAwareOrderComparator} is an extension of
 * {@link OrderComparator} that supports Spring's
 * {@link org.algorithmx.rulii.lib.spring.core.Ordered} interface as well as the
 ...
 * @since 2.0.1
 * @see org.algorithmx.rulii.lib.spring.core.Ordered
 * @see Order
...
public class AnnotationAwareOrderComparator extends OrderComparator {
	 ...
	 * elements, in addition to the {@link org.algorithmx.rulii.lib.spring.core.Ordered}
	...
	private Integer findOrderFromAnnotation(Object obj) {
		...
		org.algorithmx.rulii.lib.spring.core.annotation.MergedAnnotations annotations = org.algorithmx.rulii.lib.spring.core.annotation.MergedAnnotations.from(element, SearchStrategy.TYPE_HIERARCHY);
		Integer order = org.algorithmx.rulii.lib.spring.core.annotation.OrderUtils.getOrderFromAnnotations(element, annotations);
	...
	public Integer getPriority(Object obj) {
		if (obj instanceof Class) {
			return org.algorithmx.rulii.lib.spring.core.annotation.OrderUtils.getPriority((Class<?>) obj);
		}
		Integer priority = org.algorithmx.rulii.lib.spring.core.annotation.OrderUtils.getPriority(obj.getClass());
