...
abstract class AbstractMergedAnnotation<A extends Annotation> implements MergedAnnotation<A> {
	...
	@Override
	public org.algorithmx.rulii.lib.spring.core.annotation.MergedAnnotation<A> filterDefaultValues() {
		return filterAttributes(this::hasNonDefaultValue);
	}

	@Override
	public org.algorithmx.rulii.lib.spring.core.annotation.AnnotationAttributes asAnnotationAttributes(Adapt... adaptations) {
		return asMap(mergedAnnotation -> new org.algorithmx.rulii.lib.spring.core.annotation.AnnotationAttributes(mergedAnnotation.getType()), adaptations);
	}

	@Override
	public Optional<A> synthesize(Predicate<? super org.algorithmx.rulii.lib.spring.core.annotation.MergedAnnotation<A>> condition)
