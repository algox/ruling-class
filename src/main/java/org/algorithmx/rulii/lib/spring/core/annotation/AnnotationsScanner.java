...
import org.algorithmx.rulii.lib.spring.core.annotation.AnnotationsProcessor;
import org.algorithmx.rulii.lib.spring.core.BridgeMethodResolver;
import org.algorithmx.rulii.lib.spring.core.Ordered;
import org.algorithmx.rulii.lib.spring.core.ResolvableType;
...
abstract class AnnotationsScanner {
	...
	private static <C, R> R processClassInheritedAnnotations(C context, Class<?> source,
		...
		try {
			...
			org.algorithmx.rulii.lib.spring.core.annotation.AnnotationUtils.handleIntrospectionFailure(source, ex);
		}
		return null;
	}
	...
	private static <C, R> R processMethodHierarchy(C context, int[] aggregateIndex,
		...
		try {
			...
			org.algorithmx.rulii.lib.spring.core.annotation.AnnotationUtils.handleIntrospectionFailure(rootMethod, ex);
		}
		return null;
	}
