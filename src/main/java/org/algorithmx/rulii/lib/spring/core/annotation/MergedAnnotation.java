...
public interface MergedAnnotation<A extends Annotation> {
	...
	static <A extends Annotation> MergedAnnotation<A> missing() {
		return org.algorithmx.rulii.lib.spring.core.annotation.MissingMergedAnnotation.getInstance();
	}
	...
	static <A extends Annotation> MergedAnnotation<A> from(@Nullable Object source, A annotation) {
		return org.algorithmx.rulii.lib.spring.core.annotation.TypeMappedAnnotation.from(source, annotation);
	}
	...
	static <A extends Annotation> MergedAnnotation<A> of(
		...
		return org.algorithmx.rulii.lib.spring.core.annotation.TypeMappedAnnotation.of(classLoader, source, annotationType, attributes);
	}
