...
@ValidationRule(AssertFalse.AssertFalseValidationRuleBuilder.class)
public @interface AssertFalse {
    ...
    class AssertFalseValidationRuleBuilder implements BindingValidationRuleBuilder<AssertFalse> {
