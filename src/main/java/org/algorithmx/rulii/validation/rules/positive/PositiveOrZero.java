...
@ValidationMarker(PositiveOrZero.PositiveOrZeroValidationRuleBuilder.class)
public @interface PositiveOrZero {
    ...
    class PositiveOrZeroValidationRuleBuilder implements AnnotatedRunnableBuilder<PositiveOrZero> {
        ...
        @Override
        public Rule[] build(PositiveOrZero positiveOrZero, String bindingName, String path) {
            PositiveOrZeroValidationRule rule = new PositiveOrZeroValidationRule(bindingName, path,
