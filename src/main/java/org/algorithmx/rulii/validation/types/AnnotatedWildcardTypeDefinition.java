...
public class AnnotatedWildcardTypeDefinition extends AbstractAnnotatedTypeDefinition<AnnotatedWildcardType> {
    ...
    public AnnotatedWildcardTypeDefinition(AnnotatedWildcardType annotatedType, AnnotatedTypeDefinition...bounds) {
        super(annotatedType, AnnotatedTypeKind.WILDCARD_TYPE, deriveRequiresTraversal(bounds));
