...
public class AnnotatedArrayTypeDefinition extends AbstractAnnotatedTypeDefinition<AnnotatedArrayType> {
    ...
    public AnnotatedArrayTypeDefinition(AnnotatedArrayType annotatedType, AnnotatedTypeDefinition componentType) {
        super(annotatedType, AnnotatedTypeKind.ARRAY_TYPE, deriveRequiresTraversal(componentType));
