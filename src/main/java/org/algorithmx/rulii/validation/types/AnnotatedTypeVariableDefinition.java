...
public class AnnotatedTypeVariableDefinition extends AbstractAnnotatedTypeDefinition<AnnotatedTypeVariable> {
    ...
    public AnnotatedTypeVariableDefinition(AnnotatedTypeVariable annotatedType, AnnotatedTypeDefinition...bounds) {
        super(annotatedType, AnnotatedTypeKind.TYPE_VARIABLE_TYPE, deriveRequiresTraversal(bounds));
