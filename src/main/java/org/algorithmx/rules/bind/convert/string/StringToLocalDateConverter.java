 ...
 * @since 1.0
 */
public class StringToLocalDateConverter extends ConverterTemplate<String, LocalDate> {
    ...
    @Override
    public LocalDate convert(String value, Type toType) throws ConversionException {
