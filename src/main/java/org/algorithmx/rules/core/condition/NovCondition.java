...
@FunctionalInterface
public interface NovCondition<A, B, C, D, E, F, G, H, I> extends FunctionalCondition {
    ...
    default boolean isPass(Object... params) throws UnrulyException {
        ...
        return when((A) params[0], (B) params[1], (C) params[2], (D) params[3], (E) params[4], (F) params[5],
                (G) params[6], (H) params[7], (I) params[8]);
    }

    boolean when(A arg0, B arg1, C arg2, D arg3, E arg4, F args5, G args6, H args7, I args8);
}
