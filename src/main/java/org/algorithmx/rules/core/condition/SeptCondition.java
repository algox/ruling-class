...
/**
 * Functional Condition taking in seven parameters.
 *
 ...
 */
@FunctionalInterface
public interface SeptCondition<A, B, C, D, E, F, G> extends FunctionalCondition {

    /**
     * Condition logic taking in seven args.
     *
     * @param arg0 1st arg.
     * @param arg1 2nd arg.
     * @param arg2 3rd arg.
     ...
     */
    boolean isPass(A arg0, B arg1, C arg2, D arg3, E arg4, F arg5, G arg6);
    ...
    default boolean isPass(Object...args) throws UnrulyException {
        ...
        return isPass((A) args[0], (B) args[1], (C) args[2], (D) args[3], (E) args[4], (F) args[5], (G) args[6]);
    }
}
