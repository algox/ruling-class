...
public class FutureValidationRule extends SingleValueValidationRule {
    ...
    public FutureValidationRule() {
        this(ERROR_CODE, Severity.ERROR, null);
    }

    public FutureValidationRule(String errorCode, Severity severity, String errorMessage) {
