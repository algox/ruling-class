...
@ValidationRuleBuilder(producer = DecimalMax.DecimalMaxValidationRuleProducer.class)
public @interface DecimalMax {
    ...
    class DecimalMaxValidationRuleProducer implements ValidationRuleProducer<DecimalMax> {

        public DecimalMaxValidationRuleProducer() {
            super();
        }

        @Override
        public void produce(DecimalMax max, RuleSetBuilder builder) {
        ...
        @Override
        public Class<?>[] types() {
            return DecimalMaxValidationRule.SUPPORTED_TYPES;
        }
    }
}
