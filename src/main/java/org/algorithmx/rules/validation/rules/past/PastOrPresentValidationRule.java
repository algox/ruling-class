...
public class PastOrPresentValidationRule extends SingleValueValidationRule {
    ...
    public PastOrPresentValidationRule() {
        this(ERROR_CODE, Severity.ERROR, null);
    }

    public PastOrPresentValidationRule(String errorCode, Severity severity, String errorMessage) {
