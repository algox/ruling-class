...
public class NegativeValidationRule extends SingleValueValidationRule {
    ...
    public NegativeValidationRule() {
        this(ERROR_CODE, Severity.ERROR, null);
    }

    public NegativeValidationRule(String errorCode, Severity severity, String errorMessage) {
