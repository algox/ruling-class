...
@ValidationRuleBuilder(Size.SizeValidationRuleBuilder.class)
public @interface Size {
    ...
    class SizeValidationRuleBuilder implements SingleValueValidationRuleBuilder<Size> {
        ...
        @Override
        public RuleSetBuilder build(Size size, RuleSetBuilder builder) {
