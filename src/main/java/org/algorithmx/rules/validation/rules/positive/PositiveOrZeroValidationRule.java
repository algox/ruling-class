...
public class PositiveOrZeroValidationRule extends SingleValueValidationRule {
    ...
    public PositiveOrZeroValidationRule(String errorCode, Severity severity, String errorMessage) {
