...
@ValidationRuleBuilder(producer = Max.MaxValidationRuleProducer.class)
public @interface Max {
    ...
    class MaxValidationRuleProducer implements ValidationRuleProducer<Max> {

        public MaxValidationRuleProducer() {
            super();
        }

        @Override
        public void produce(Max max, RuleSetBuilder builder) {
        ...
        @Override
        public Class<?>[] types() {
            return MaxValidationRule.SUPPORTED_TYPES;
        }
    }
}
