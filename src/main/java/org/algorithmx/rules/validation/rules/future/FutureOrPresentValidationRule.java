...
public class FutureOrPresentValidationRule extends SingleValueValidationRule {
    ...
    public FutureOrPresentValidationRule() {
        this(ERROR_CODE, Severity.ERROR, null);
    }

    public FutureOrPresentValidationRule(String errorCode, Severity severity, String errorMessage) {
    ...
    public String toString() {
        return "FutureOrPresentValidationRule{}";
    }
}
