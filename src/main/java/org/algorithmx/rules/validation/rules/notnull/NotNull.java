...
@ValidationRuleBuilder(producer = NotNull.NotNullValidationRuleProducer.class)
public @interface NotNull {
    ...
    class NotNullValidationRuleProducer implements ValidationRuleProducer<NotNull> {

        public NotNullValidationRuleProducer() {
            super();
        }

        @Override
        public void produce(NotNull notNull, RuleSetBuilder builder) {
        ...
        @Override
        public Class<?>[] types() {
            return NotNullValidationRule.SUPPORTED_TYPES;
        }
    }
}
