...
public class NotEmptyValidationRule extends SingleValueValidationRule {
    ...
    public NotEmptyValidationRule(String errorCode, Severity severity, String errorMessage) {
