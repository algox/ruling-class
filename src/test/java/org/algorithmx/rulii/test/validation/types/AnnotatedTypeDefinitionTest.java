...
public class AnnotatedTypeDefinitionTest<T extends Number, R extends List> {
    ...
    private List<@NotNull @DecimalMin(25.00) BigDecimal> field7;
    @Validate
    private TestClass<String> field8;
    ...
    /*@Test
    public void test1() {
        AnnotatedTypeDefinitionBuilder builder = new AnnotatedTypeDefinitionBuilder(AnnotatedRule.class, Traverse.class);
    ...
    public void test7() {
        ...
        Assert.assertNotNull(definition);
        AnnotatedParameterizedTypeDefinition annotatedTypeVariableDefinition = (AnnotatedParameterizedTypeDefinition) definition;
        Assert.assertTrue(annotatedTypeVariableDefinition.getTypeArguments()[0].getExtractor().equals(TestClassExtractor.class));
    }
